...
export class LabTestController {
  ...
  @Patch('lab-field/:id')
  updateLabField(@Req() req: Request, @Param('id') id: string) {
    return this.labTestService.updateLabField(id, req);
  }

  @Delete('lab-field/:id')
  deleteLabField(@Param('id') id: string, @Req() req: Request) {
    return this.labTestService.deleteLabField(id, req);
  }

  @Get('lab-field')
  getLabField(@Query() query: Record<string, any>, @Req() req: Request) {
  ...
  // ==================================
  @Get()
  findLabTest(@Query() query: Record<string, any>, @Req() req: Request) {
  ...
  deleteQuantitativeTest(@Param('id') id: string, @Req() req: Request) {
  ...
  // ==================================
  @Get('imaging/:id')
  getImagingTestById(@Param('id') id: string, @Req() req: Request) {

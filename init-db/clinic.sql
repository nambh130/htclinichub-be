...
--
-- Name: clinic_service; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE clinic_service WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE clinic_service OWNER TO postgres;

\connect clinic_service

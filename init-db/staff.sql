...
--
-- Name: staff_service; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE staff_service WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE staff_service OWNER TO postgres;

\connect staff_service

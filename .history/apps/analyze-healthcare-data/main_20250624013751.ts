...
import { INPUT_VITAL_SIGNS_CONSUMER_GROUP, PATIENT_CONSUMER_GROUP } from '@app/common';
import { AnalyzeHealthcareDataModule } from './src/analyze-healthcare-data.module';

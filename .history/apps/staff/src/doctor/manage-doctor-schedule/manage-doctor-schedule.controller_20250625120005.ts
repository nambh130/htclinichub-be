...
export class ManageDoctorScheduleController {
  ...
  @MessagePattern('doctor-view-working-shift') doctor-view-working-shift
  async getViewWorkingShiftController(
    ...
    //   const patient = await this.manageDoctorScheduleService.getViewWorkingShiftService(doctorId, userId);
      return doctorId + "Khánh Hà bị đao" + data.doctorId;
    } catch (error) {

...
export class StaffController {
  constructor(
    ...
    private readonly staffService: ManageDoctorScheduleService
  ...
  async getViewWorkingShift(
    ...
    try {
      const patient = await this.patientService.getViewWorkingShiftService(doctorId, user._id.toString());
      return patient;
    } catch (error) {
